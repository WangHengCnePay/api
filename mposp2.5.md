...
| 获取银联二维码系统户列表| [/getUnionAcqMerchantList](#getUnionAcqMerchantList)              | urlencoded           | GET |王恒| 是   |
----------------------------------------------------------------------------------
...
<a id="getUnionAcqMerchantList"></a>
### 获取银联二维码系统户列表  /getUnionAcqMerchantList
#### 1\. 获取银联二维码系统户列表
请求：  
```
GET /getAcqMerchantList HTTP/1.1
